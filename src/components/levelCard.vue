    ...
    <div class="levels-wrapper">
        <div v-if="!userStore.isLoggedIn" class="guest-notice">
            <p>
                ...
                <RouterLink to="/register">register</RouterLink> to track your
                progress and unlock levels.
            </p>
        </div>
        ...
        <div class="levels-grid">
            ...
            >
                ...
                <div class="level-icon">
                    ...
                    <span v-else-if="level.id === userStore.currentLevel"
                        >▶</span
                    >
                    <span v-else>🔒</span>
                </div>
                ...
                <div class="level-info">
                    ...
                    <span class="level-status" :class="levelClass(level.id)">
                        <template v-if="!userStore.isLoggedIn"
                            >Login to unlock</template
                        >
                        <template v-else-if="level.id < userStore.currentLevel"
                            >Completed</template
                        >
                        <template
                            v-else-if="level.id === userStore.currentLevel"
                            >Available</template
                        >
                ...
                <RouterLink
                    v-if="
                        ...
                        level.id <= userStore.currentLevel
                    "
