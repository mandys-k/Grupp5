    ...
    <div class="listningcomprehension">
        ...
        <div class="listning-container">
            <div class="script">
                <audio
                    ref="audioPlayer"
                    src="../assets/listningcomprehension.mp3"
                ></audio>
                ...
                <div v-if="showScript" class="card">
                    <p>
                        A: Buongiorno! Vorrei un caffè e un cornetto, per
                        favore.<br />
                    ...
                    <div v-if="showEnglish" class="card">
                        A: Good morning! I would like a coffee and a croissant,
                        please.<br />
...
<script setup>
    ...
    const questions = ref([
        ...
        },
        {
            ...
            answer: 1,
            options: ["Sì", "No", "Forse", "Non lo dice"],
            selected: null
        },
        {
            question: "Q3: Quanto costa in totale?",
            answer: 0,
            options: ["Tre euro", "Due euro", "Cinque euro", "Dieci euro"],
            selected: null
        },
        {
            question: "Q4: È mattina o sera?",
            answer: 3,
            options: ["Pomeriggio", "Sera", "Notte", "Mattina"],
            selected: null
        }
    ])
